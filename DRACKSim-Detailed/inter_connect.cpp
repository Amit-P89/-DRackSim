...
void network_memory_completion(deque<packet> *packet_queue_dest, vector<remote_memory_access> *mem_response, int dest_count)
{
	for (int i = 0; i < dest_count; i++)
	{
...
void simulate_network_reverse()
{
	...
	network_memory_completion(rx_packet_queue_node, memory_completion_queue, num_nodes);
