...
$${\color{white}***Citation Link:***}$$
```
$${\color{white}Puri, A., Kartheek Bellamkonda, Kailash Narreddy Jose, J., Venkatesh, T., & Narayanan, V. (2023). DRackSim: Simulator for Rack-scale Memory Disaggregation. ArXiv. /abs/2305.09977}$$
```

$${\color{white}***Full Paper Link:***}$$
$${\color{white}https://arxiv.org/abs/2305.09977}$$
